...
// --- KOMPONENTY WYDZIELONE Z APP ---
const Navbar = ({ navigate, currentView, setIsCartOpen, iloscWKoszyku }) => (
...
const CartDrawer = ({ isCartOpen, setIsCartOpen, koszyk, sumaKoszyka, zmienIlosc, navigate }) => (
  <>
...
const HomeView = ({ navigate, dodajDoKoszyka }) => (
  <>
...
const ProductView = ({ selectedProduct, dodajDoKoszyka }) => {
...
const CheckoutView = ({ koszyk, sumaKoszyka, wyczyscKoszyk, navigate }) => {
            ...
            <div className="animate-[fadeIn_0.4s_ease-out_forwards]">
              ...
              <div className="space-y-3 mb-10">
                <label className="flex items-center gap-4 border border-[#111111] p-4 cursor-pointer bg-[#F5F5F5]/30">
                  ...
                  <span className="font-['Montserrat'] font-bold text-sm uppercase flex items-center gap-2">BLIK</span>
                </label>
              </div>
              <div className="flex gap-4">
...
export default function App() {
  ...
  return (
    <div className="bg-white text-[#111111] antialiased selection:bg-[#111111] selection:text-white font-['Inter']">
      <Navbar navigate={navigate} currentView={currentView} setIsCartOpen={setIsCartOpen} iloscWKoszyku={iloscWKoszyku} />
      
      <CartDrawer isCartOpen={isCartOpen} setIsCartOpen={setIsCartOpen} koszyk={koszyk} sumaKoszyka={sumaKoszyka} zmienIlosc={zmienIlosc} navigate={navigate} />
      
      {currentView === 'home' && <HomeView navigate={navigate} dodajDoKoszyka={dodajDoKoszyka} />}
      {currentView === 'product' && <ProductView selectedProduct={selectedProduct} dodajDoKoszyka={dodajDoKoszyka} />}
      {currentView === 'kasa' && <CheckoutView koszyk={koszyk} sumaKoszyka={sumaKoszyka} wyczyscKoszyk={wyczyscKoszyk} navigate={navigate} />}
